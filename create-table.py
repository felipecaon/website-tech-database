...
CREATE_TECHNOLOGIES_TABLE = (
    "CREATE TABLE technologies(id INTEGER PRIMARY KEY, technology VARCHAR);"
)
CREATE_UNIQUE_INDEX_SITES_SITE = "CREATE UNIQUE INDEX sites_site ON sites(site);"
CREATE_UNIQUE_INDEX_TECHNOLOGIES_TECHNOLOGY = (
    "CREATE UNIQUE INDEX technologies_technology ON technologies(technology);"
)
