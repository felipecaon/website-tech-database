...
def menu():
	...
	parser.add_option('-u', '--url', dest="url", help='Target url (ex. http://target-uri/)')
...
CHECK_IF_SITE_TECHNOLOGY_EXISTS = "SELECT id FROM site_technology WHERE site_id = '{}' AND technology_id = '{}'";
...
INSERT_SITE_TECHNOLOGY = "INSERT OR IGNORE INTO site_technology(site_id, technology_id) VALUES ('{}', '{}')";
